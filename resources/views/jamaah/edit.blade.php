    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><i class="fa-solid fa-user-pen" style="margin-right: 10px"></i>Data Jamaah</h4>
            </div>

            <div class="card-body">
                <form action="{{ route('jamaah.update', $query->id)}}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nij') is-invalid @enderror" id="nij"
                                    name="nij" placeholder="NIJ" value="{{ $query->nij }}">
                                @error('nij')
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('namajamaah') is-invalid @enderror"
                                    id="namajamaah" name="namajamaah" placeholder="Nama Jamaah"
                                    value="{{ $query->namajamaah }}">
                                @error('namajamaah')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
